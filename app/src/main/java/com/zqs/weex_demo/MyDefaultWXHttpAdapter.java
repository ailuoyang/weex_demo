...
public class MyDefaultWXHttpAdapter implements IWXHttpAdapter {
    ...
    execute(new Runnable() {
      ...
      public void run() {
        ...
        try {
          ...
          Log.w("mTest", "errorMsg:" + e.getMessage());
          if(listener!=null){
            listener.onHttpFinish(response);
          }
  ...
  private byte[] readInputStreamAsBytes(InputStream inputStream,OnHttpListener listener) throws IOException{
    ...
    Log.w("mTest", "responseData->readInputStreamAsBytes:"+new String(data));
    buffer.flush();
  ...
  private String readInputStream(InputStream inputStream, OnHttpListener listener) throws IOException {
    ...
    Log.w("mTest", "responseData->readInputStream:"+new String(data));
